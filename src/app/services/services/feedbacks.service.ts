...
import { PageDtoFeedbackRsp } from '../models/page-dto-feedback-rsp';
...
export class FeedbacksService extends BaseService {
   ...
   */
  findAllFeedbackByBook$Response(params: FindAllFeedbackByBook$Params, context?: HttpContext): Observable<StrictHttpResponse<PageDtoFeedbackRsp>> {
   ...
   * This method doesn't expect any request body.
   */
  findAllFeedbackByBook(params: FindAllFeedbackByBook$Params, context?: HttpContext): Observable<PageDtoFeedbackRsp> {
    return this.findAllFeedbackByBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<PageDtoFeedbackRsp>): PageDtoFeedbackRsp => r.body)
    );
  }
